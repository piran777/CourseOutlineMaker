...
const EditPDF = () => {
    ...
    "
                        ...
                        <h4>CEAB Academic Units: Engineering Science {<input className='shortText'
                            type="number"
                            name="CEAB"
                            defaultValue={data.CEAB}
                            onChange={handleChange}
                            placeholder="X%"
                        />} Engineering Design {<input className='shortText'
                            type="number"
                            name="nameDes"
                            defaultValue={data.nameDes}
                            onChange={handleChange}
                            placeholder="Y%"
                        />}
                        </h4>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input className='shortText'
                                    type="text"
                                    name="investigation"
                                    defaultValue={data.investigation}
                                    onChange={handleChange}
                                    placeholder="x"
                                /></td>
